...
void HandlePositionCommand(string input)
{
    ...
    {
        // Parse FEN string to set up the position
        string fen = input.Substring(13).Split(' ')[0];
...
{
    // Assuming moveString is in the format like "e2e4"
    ...
    return new MoveObject
    {
        ...
        IsCapture = globals.ChessBoard[endSquare] != Piece.None // Assuming 0 means empty square
