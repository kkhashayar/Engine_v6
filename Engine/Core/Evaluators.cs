...
//                    score += 1;
//                    if (gamePhase == GamePhase.Opening)
//                        score += Pawns.GetSquareWeight(i, true);
//                    break;

//                case 3: // White Knight
//                    score += 3;
//                    if (gamePhase == GamePhase.Opening)
//                        score += Knights.GetSquareWeight(i, true);
//                    break;

//                case 4: // White Bishop
//                    score += 3;
//                    if (gamePhase == GamePhase.Opening)
//                        score += Bishops.GetSquareWeight(i, true);
//                    break;
...
//                    score += 999999;
//                    if (gamePhase == GamePhase.EndGame)
//                        score += Kings.GetEndGameWeight(i, true);
//                    else
//                        score += Kings.GetMiddleGameWeight(i, true);
//                    break;

//                case 11: // Black Pawn
//                    score -= 1;
//                    if (gamePhase == GamePhase.Opening)
//                        score -= Pawns.GetSquareWeight(i, false);
//                    break;

//                case 13: // Black Knight
//                    score -= 3;
//                    if (gamePhase == GamePhase.Opening)
//                        score -= Knights.GetSquareWeight(i, false);
//                    break;

//                case 14: // Black Bishop
//                    score -= 3;
//                    if (gamePhase == GamePhase.Opening)
//                        score -= Bishops.GetSquareWeight(i, false);
//                    break;
...
//                    score -= 999999;
//                    if (gamePhase == GamePhase.EndGame)
//                        score -= Kings.GetEndGameWeight(i, false);
//                    else
//                        score -= Kings.GetMiddleGameWeight(i, false);
//                    break;
//            }
//        }
...
//        score += (turn == 0)
//            ? GetMoveCountBonus(blackMoveCount)
//            : -GetMoveCountBonus(whiteMoveCount);
...
//    public static bool IsPositionDraw(int turn, int whiteMoveCount, int blackMoveCount)
//    {
//        return (turn == 0 && blackMoveCount == 0) || (turn == 1 && whiteMoveCount == 0);
//    }
//}
